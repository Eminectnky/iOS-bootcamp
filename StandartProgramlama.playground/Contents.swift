...
print("a > b || x > y : \(a > b || x > y)") // || = OR(VEYA), false - false : false olur, diğer durumlarda hep true olur.


print("a > b && x > y : \(a > b && x > y)") // && = AND(VE), true - true : true olur, diğer durumlarda hep false olur.
...
if sonuc == 9 || sonuc == 10 {
    ...
    print("Sonuc 9 vaya 10 değildir")
}
...
//continue ise o anki adımı pas geçiyor ve bir sonraki adımdan devam ediyor 
for i in 1...5 {
    if i == 3 {
        continue
    }
