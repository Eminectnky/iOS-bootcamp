...
//  KisilerUygulamasi
//
//  Created by Emine CETINKAYA on 13.12.2023.
//
...
extension Anasayfa: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let kisi = kisilerListesi[indexPath.row] //kisiler listemdeki verileri sırayla, teker teker bana verir
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        tableView.deselectRow(at: indexPath, animated: true)// seçimi kaldırmak için
    }
