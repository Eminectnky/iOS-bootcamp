...
class Anasayfa: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        urunlerTableView.separatorColor = UIColor(white: 0.95, alpha: 1) //cell ler arasındaki çizgiyi kaldırır aslında kaldırmaz ama rengini beyaz verdiğimiz için görünmez
    }
}
